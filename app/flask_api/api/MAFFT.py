...
class MafftCommandline(AbstractCommandline):
    ...
    def __init__(self, cmd="mafft", **kwargs):
        ...
        self.parameters = [
            ...
            # form: mafft --add new_sequences existing_alignment > output
            _Option(
                ["--add", "add"],
                "mafft --add new_sequences existing_alignment > output"
                "Sequences in new_sequences are ungapped"
                "and then aligned to existing_alignment."
            ...
            _Argument(["input"], "Input file name",
